...
namespace stephencoduor\OAuth2\Client\Provider;
...
use stephencoduor\OAuth2\Client\Provider\CanvasLMSResourceOwner;
...
class CanvasLMS extends AbstractProvider
{
     ...
     */
    protected $grantType;
    /* TODO https://github.com/stephencoduor/oauth2-canvaslms/issues/1 */
    ...
    public function getAccessTokenRequest(array $params)
    {
        ...
        $uri = $request->getUri()->withUserInfo($this->clientId,
            $this->clientSecret);
